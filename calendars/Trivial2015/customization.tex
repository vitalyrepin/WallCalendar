...
%% Contact email
\def\ContactEmail{anonymous@fake.fu}
%% Contact city
\def\ContactCity{Nowhere}
%% Contact country
\def\ContactCountry{Example Country}
%% Keywords (to be included into pdf)
\def\Keywords{calendar,2015,example,trivial}
...
%% Path to the photos
\def\PhotoPath{photos/}

%% Images and descriptions for the month pages
\def\Jan{mosaic}
\def\JanDscRU{Январь}
\def\JanDscEN{January}

\def\Feb{gamma}
\def\FebDscRU{Февраль}
\def\FebDscEN{February}
...
\def\Sep{mosaic}
\def\SepDscRU{Сентябрь}
\def\SepDscEN{September}

\def\Oct{gamma}
\def\OctDscRU{Октябрь}
\def\OctDscEN{October}

\def\Nov{mosaic}
\def\NovDscRU{Ноябрь}
\def\NovDscEN{November}

\def\Dec{gamma}
\def\DecDscRU{Декабрь}
\def\DecDscEN{December}

%% Names on the title and back covers in russian and english
\def\caltitleRU{Демо / Пример}
\def\caltitleEN{Пример}
