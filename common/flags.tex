...
%% Orthodoxy christ
\input{common/flags/orthodox}

%% Flag of the Russian Space Troops
\newcommand{\flagRusSpace}{\includegraphics{common/flags/SpaceFlag.png}}

%% Flag of the Russian Arborne Troops
\newcommand{\flagRusAirborne}{\includegraphics{common/flags/RusAirborne.png}}

%% St. Petersburg flag
\newsavebox{\flagSpb}
\savebox{\flagSpb}{\includegraphics{common/flags/SpbFlag.pdf}}

%% Flag of the Russian Ministry of Defence
\newsavebox{\flagRusDefence}
\savebox{\flagRusDefence}{\includegraphics{common/flags/RusDefence.png}}

%% Saint George ribbon - Vicory Day. 9, May.
\newcommand{\flagVictory}{\rotatebox{90}{\includegraphics{common/flags/9May.png}}}

%% FSB flag
\input{common/flags/fsb}
