...
\multicolumn{2}{l}{\includegraphics[keepaspectratio,width=\CalExAspectRatio\purePaperWidth]{photos/\GetMonthImage{7}}}\\
...
\newcommand{\thumb}[1]{\frame{\includegraphics[keepaspectratio,width=\ThumbAspectRation\purePaperWidth]{photos/\GetMonthImage{#1}}}}
\vspace*{.25cm}

%% QR code
\newcommand{\QR}{%
\begin{pspicture}(1in,1in)
\psbarcode{http://www.flickr.com/photos/vitalyrepin/collections/72157602224858025/}{eclevel=H}{qrcode}
\end{pspicture}
}
...
\tiny%
\begin{tabular}{ll}
\frame{\colorbox{white}{\includegraphics{isbn_barcode}}}&\raisebox{-.81cm}{\QR}\\[.2cm]
\textsc{\caltitleEN}&\\
\textsc{\caltitleRU}&\\[.2cm]
\textcopyright\ Vitaly Repin, 2013. All rights reserved.&\\
\end{tabular}
\endgroup
}
...
\thumb{11}&\thumb{12}&\multicolumn{2}{l}{\hspace*{-.4cm}\raisebox{1.52cm}{\usebox{\isbn}}}\\
\end{tabular}}
