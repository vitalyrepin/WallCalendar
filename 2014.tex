...
\begin{tikzpicture}[thick]
  ...
  if (equals=08-02) [observance=День ВДВ]
  ...
  if (equals=02-22, 
  	equals=03-15,
	equals=03-22,
	equals=03-29) [observance=Вселенская\\ родительская суббота]
  ...
  if (equals=04-17) [observance=Тайная Вечеря]
  if (equals=04-18) [observance=Великий\\ Пяток]
  if (equals=04-20) [observance=Пасха]
  if (equals=09-03) [observance=Торжество\\ Православия]
  ...
  if (equals=12-12) [observance=День Петра и Павла]
;
